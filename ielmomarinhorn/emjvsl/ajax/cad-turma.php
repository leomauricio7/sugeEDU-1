	...
	<div class="col-xs-12 col-sm-12">
		<div class="box">
			...
			<div class="box-content">
				...
				<form class="form-horizontal" role="form" method="post" action="./includes/cad-turma.php">
					<div class="form-group">
						<label class="col-sm-2 control-label">Nome: </label>
						<div class="col-sm-10">
							<input type="text" name="nome" minlength="4" maxlength="20" class="form-control" required placeholder="Digite o nome da turma" data-toggle="tooltip" data-placement="bottom" title="Turma">
						</div> 
					</div> 
					...
					<div class="form-group">
						...
						<div class="col-sm-2">
							<input type="text" name="sala" minlength="1" maxlength="4" class="form-control" required placeholder="Informe a sala" data-toggle="tooltip" data-placement="left" title="Sala">
						</div>
